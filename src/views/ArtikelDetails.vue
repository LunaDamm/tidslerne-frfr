...
<div class="bg-white w-4/4 sm:w-3/4  p-4 rounded-sm ">
    <div class="pb-4">
      <h1 class="sm:!text-[40px] !text-[32px] text-dark-green font-bold">{{ artikel.name }}</h1>
...
<div class="kilder w-4/4 sm:w-3/4 flex flex-wrap gap-1 pl-4 sm:pl-0" >
  <p class=" text-dark-green" v-if="artikel.source">Kilde:</p>
        <a class="text-dark-green underline hover:text-logo-purple ease-in duration-300" v-if="artikel.source" :href="artikel.source">{{ artikel.source }}</a>
  </div>

<div class="tagKnapper w-4/4 sm:w-3/4 flex flex-wrap gap-3 font-bold pl-4 sm:pl-0">
